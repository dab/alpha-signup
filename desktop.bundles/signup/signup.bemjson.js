                                ...
                                content: [
                                    {
                                        ...
                                        text: 'iPhone or iPad',
                                        val: '2',
                                        name: 'group[Devices][iOS]'
                                    }
                                ]
                            },
                            {
                                elem: 'title',
                                content: 'Desktop or laptop PC\’s running:'
                            ...
                            content: [
                                {
                                    ...
                                    content: 'My broadband downstream speed:'
                                },
                                {
                                    block: 'radio',
                                    name: 'connection',
                                    id: 'connection',
                                    options: [
                                        { text: '< 5Mbps', val: '< 5Mbps' },
                                        { text: '5 - 20Mbps', val: '5 - 20Mbps' },
                                        { text: '> 20Mbps', val: '> 20Mbps' }
                                    ]
                                }
                            ]
                        }
